...
public class Config {
	...
	public enum Dataset {
		DATA_GOV, PLISTA, PLISTA_SMALL, PLISTA_LARGE, TPC_H, TPC_H_10, TPC_H_30, TPC_H_50, TPC_H_70, MUSICBRAINZ, MUSICBRAINZ_SMALL, BIOSQLSP, CATH, CENSUS, COMA,
	...
	public Config() {
		this(Config.Algorithm.BINDER, Config.Database.MYSQL, Dataset.DATA_GOV);
	}
